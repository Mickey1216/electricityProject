        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="(supSaleAttr,index) in spuSaleAttrList" :key="supSaleAttr.id">
                <dt class="title">{{supSaleAttr.saleAttrName}}</dt>
                <dd
                  changepirce="0"
                  :class="{'active':supSaleAttrValue.isChecked === '1'}"
                  v-for="(supSaleAttrValue,index) in supSaleAttr.spuSaleAttrValueList"
                  :key="supSaleAttrValue.id"
                  @click="changeActive(supSaleAttrValue,supSaleAttr.spuSaleAttrValueList)"
                >{{supSaleAttrValue.saleAttrValueName}}</dd>
              </dl>
            </div>
            <div class="cartWrap">
              <div class="controls">
